...
public class DataSeeder {
    ...
    private void seedComplaints() {
        Citizen citizen1 = citizenRepository.findById(1L).orElseThrow();
        Citizen citizen2 = citizenRepository.findById(2L).orElseThrow();
        Citizen citizen3 = citizenRepository.findById(3L).orElseThrow();
        User admin = userRepository.findByEmail("admin@example.com").orElseThrow();
