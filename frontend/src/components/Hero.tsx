        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Nền tảng kết nối toàn diện: Cư dân chụp ảnh báo cáo rác, AI hỗ trợ phân loại,
              Collector thu gom tối ưu và Doanh nghiệp quản lý hiệu quả.
            </p>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            <div className="relative z-10 w-full max-w-md mx-auto aspect-square">
              ...
              <svg
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] text-brand-200 fill-current"
              >
                <path
              ...
              <img
                ...
                className="relative z-20 w-full h-full object-cover rounded-[3rem] shadow-2xl animate-float"
              />
