...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "shell-card rounded-[24px] text-[var(--text-primary)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-2 px-5 py-4 sm:px-6 sm:py-5", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-[-0.03em] text-[var(--text-primary)]",
      className
    )}
    {...props}
  />
