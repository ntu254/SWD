        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Nền tảng công nghệ tiên phong trong quản lý rác thải đô thị và thúc đẩy kinh tế tuần
              hoàn tại Việt Nam.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="#gallery" className="hover:text-brand-500 transition-colors">
                  Hoạt Động
                </a>
              </li>
              <li>
                <a href="#reviews" className="hover:text-brand-500 transition-colors">
                  Cộng Đồng
                </a>
              </li>
            </ul>
