...
import { Menu, X, Recycle, Camera, LogIn } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button onClick={onBookNow} variant="primary" size="sm" className="hidden md:inline-flex group shadow-brand-500/20">
