import { Service, Testimonial, NavItem } from '@shared/types';
...
export const FEATURES = [
    {
        ...
        icon: React.createElement(Truck, { className: "w-6 h-6 text-brand-500" }),
    },
    {
        title: 'Kinh Tế Tuần Hoàn',
        description: 'Biến rác thải thành tài nguyên, tích điểm thưởng.',
        icon: React.createElement(Recycle, { className: "w-6 h-6 text-brand-500" }),
    },
    {
        title: 'Sống Xanh',
        description: 'Hướng dẫn phân loại rác tại nguồn chuẩn 2025.',
        icon: React.createElement(Leaf, { className: "w-6 h-6 text-brand-500" }),
    },
    {
        title: 'Dữ Liệu Minh Bạch',
        description: 'Theo dõi lộ trình rác thải và tác động môi trường.',
        icon: React.createElement(BarChart3, { className: "w-6 h-6 text-brand-500" }),
    },
];
