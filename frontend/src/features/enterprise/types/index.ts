...
// ===================== TASK =====================
export type TaskStatus = 'PENDING' | 'PENDING_APPROVAL' | 'ACCEPTED' | 'REJECTED' | 'ASSIGNED' | 'ON_THE_WAY' | 'COLLECTED' | 'COMPLETED' | 'CANCELLED' | 'FAILED';
...
export type ComplaintCategory = 'COLLECTOR_BEHAVIOR' | 'SERVICE_QUALITY' | 'MISSED_COLLECTION' | 'WRONG_CLASSIFICATION' | 'OTHER';
