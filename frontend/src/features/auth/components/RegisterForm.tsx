      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="group space-y-1.5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <User
                  className={`transition-colors duration-300 ${errors.lastName ? 'text-red-400' : 'text-gray-400 group-focus-within:text-brand-500'}`}
                  size={18}
                />
              </div>
              <input
          ...
          <div className="group space-y-1.5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <User
                  className={`transition-colors duration-300 ${errors.firstName ? 'text-red-400' : 'text-gray-400 group-focus-within:text-brand-500'}`}
                  size={18}
                />
              </div>
              <input
        ...
        <div className="group space-y-1.5">
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
              <Mail
                className={`transition-colors duration-300 ${errors.email ? 'text-red-400' : 'text-gray-400 group-focus-within:text-brand-500'}`}
                size={18}
              />
            </div>
            <input
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="group space-y-1.5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <Lock
                  className={`transition-colors duration-300 ${errors.password ? 'text-red-400' : 'text-gray-400 group-focus-within:text-brand-500'}`}
                  size={18}
                />
              </div>
              <input
          ...
          <div className="group space-y-1.5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <Lock
                  className={`transition-colors duration-300 ${errors.confirmPassword ? 'text-red-400' : 'text-gray-400 group-focus-within:text-brand-500'}`}
                  size={18}
                />
              </div>
              <input
