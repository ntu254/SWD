    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            <Mail
              className={`group-focus-within:text-brand-500 transition-colors ${errors.email ? 'text-red-400' : 'text-gray-400'}`}
              size={18}
            />
          </div>
          <input
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            <Lock
              className={`group-focus-within:text-brand-500 transition-colors ${errors.password ? 'text-red-400' : 'text-gray-400'}`}
              size={18}
            />
          </div>
          <input
