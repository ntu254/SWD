...
import { Bell, ChevronLeft, ChevronRight, Package, Plus } from 'lucide-react';
        ...
        <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-8">
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500">Manage system users and their permissions</p>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <>
                <UserTable
                  ...
                  onDelete={id => handleDeleteClick(users.find(u => u.id === id)!)}
                ...
                <div className="flex items-center justify-between bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                  <div className="text-sm text-gray-600">
                    ...
                    {Math.min((pagination.currentPage + 1) * pagination.pageSize, pagination.total)}{' '}
