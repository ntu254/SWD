import { BarChart3, Leaf, Recycle, Truck } from 'lucide-react';
import { NavItem, Service, Testimonial } from '../types/greenloop';
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    duration: '24h - 48h',
    description:
      'Thu gom pin, máy tính, điện thoại hỏng. Xử lý an toàn theo tiêu chuẩn môi trường.',
    image:
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1605600659908-0ef719419d41?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    location: 'TP.HCM',
    content:
      'Ứng dụng tuyệt vời! Giờ tôi có thể dễ dàng đặt lịch thu gom rác tái chế và còn được tích điểm đổi quà.',
  ...
  },
  {
    ...
    location: 'Hà Nội',
    content:
      'Dịch vụ thu gom rất đúng giờ. Việc phân loại rác giúp khu phố của tôi sạch đẹp hơn hẳn.',
  ...
  },
  {
    ...
    location: 'Đà Nẵng',
    content:
      'GreenLoop giúp chúng tôi tối ưu hóa lộ trình thu gom và tiếp cận nguồn nguyên liệu tái chế chất lượng.',
